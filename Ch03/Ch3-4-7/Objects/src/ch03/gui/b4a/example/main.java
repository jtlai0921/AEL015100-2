...
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
 ...
 //BA.debugLineNum = 42;BA.debugLine="Dim a = 5, b = 0, c As Int";
_a = (int)(5);
_b = (int)(0);
_c = 0;
 //BA.debugLineNum = 43;BA.debugLine="Try";
try { //BA.debugLineNum = 44;BA.debugLine="Dim In As InputStream";
_in = new anywheresoftware.b4a.objects.streams.File.InputStreamWrapper();
 //BA.debugLineNum = 45;BA.debugLine="In = File.OpenInput(File.DirInternal, \"SomeMissingFile.txt\")";
_in = anywheresoftware.b4a.keywords.Common.File.OpenInput(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"SomeMissingFile.txt");
 } 
       catch (Exception e19) {
			processBA.setLastException(e19); //BA.debugLineNum = 47;BA.debugLine="lblOutput.Text = LastException.Message";
