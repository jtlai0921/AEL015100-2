...
__c.Log("success = false, "+String.valueOf(__c.LastException(ba)));
 };
...
_r.RunMethod2("releaseCameras",String.valueOf(__c.True),"java.lang.boolean");
...
__c.Log(String.valueOf(__c.LastException(ba)));
 };
...
final double limit34 = (int)(_numberofcameras-1);
for (_i = (int)(0); (step34 > 0 && _i <= limit34) || (step34 < 0 && _i >= limit34); _i += step34) {
...
if (true) return String.valueOf(_r.RunMethod("getFlashMode"));
...
if (true) return String.valueOf(_r.RunMethod2("get",_key,"java.lang.String"));
...
final double limit134 = (int)(_list1.getSize()-1);
for (_i = (int)(0); (step134 > 0 && _i <= limit134) || (step134 < 0 && _i >= limit134); _i += step134) {
